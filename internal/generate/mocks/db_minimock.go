...
//go:generate minimock -i github.com/FreylGit/platform_common/pkg/db.DB -o db_minimock.go -n DBMock -p mocks
...
import (
	...
	mm_db "github.com/FreylGit/platform_common/pkg/db"
...
type DBMock struct {
	...
	funcBeginTx          func(ctx context.Context, txOption pgx.TxOptions) (t1 pgx.Tx, err error)
	inspectFuncBeginTx   func(ctx context.Context, txOption pgx.TxOptions)
...
func (mmBeginTx *mDBMockBeginTx) Expect(ctx context.Context, txOption pgx.TxOptions) *mDBMockBeginTx {
	...
	mmBeginTx.defaultExpectation.params = &DBMockBeginTxParams{ctx, txOption}
...
func (mmBeginTx *mDBMockBeginTx) Inspect(f func(ctx context.Context, txOption pgx.TxOptions)) *mDBMockBeginTx {
...
func (mmBeginTx *mDBMockBeginTx) Set(f func(ctx context.Context, txOption pgx.TxOptions) (t1 pgx.Tx, err error)) *DBMock {
	if mmBeginTx.defaultExpectation != nil {
...
// Then helper
func (mmBeginTx *mDBMockBeginTx) When(ctx context.Context, txOption pgx.TxOptions) *DBMockBeginTxExpectation {
	if mmBeginTx.mock.funcBeginTx != nil {
		mmBeginTx.mock.t.Fatalf("DBMock.BeginTx mock is already set by Set")
	}
	...
	expectation := &DBMockBeginTxExpectation{
		mock:   mmBeginTx.mock,
		params: &DBMockBeginTxParams{ctx, txOption},
	}
...
func (mmBeginTx *DBMock) BeginTx(ctx context.Context, txOption pgx.TxOptions) (t1 pgx.Tx, err error) {
	...
	if mmBeginTx.inspectFuncBeginTx != nil {
		mmBeginTx.inspectFuncBeginTx(ctx, txOption)
	}

	mm_params := DBMockBeginTxParams{ctx, txOption}
	...
	if mmBeginTx.BeginTxMock.defaultExpectation != nil {
		...
		mm_got := DBMockBeginTxParams{ctx, txOption}
	...
	if mmBeginTx.funcBeginTx != nil {
		return mmBeginTx.funcBeginTx(ctx, txOption)
	}
	mmBeginTx.t.Fatalf("Unexpected call to DBMock.BeginTx. %v %v", ctx, txOption)
	return
}
